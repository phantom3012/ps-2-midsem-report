...
%   NON-CONTENT PAGES
%-------------------------------------------------------------------------------
% \maketitle %commenting to avoid multiple title pages
\titleP
\addtocontents{toc}{\vspace{-3em}} % Add a gap in the Contents, for aesthetics

% not sure if including this will fall under "midsem report standards". 
\AbstractSheet

% commenting acknowledgements because I don't want to write this for a mid-sem report (my prof didn't even give me a format)
...
\input{Chapters/Product walkthrough.tex}
\input{Chapters/Testing methodologies.tex}
